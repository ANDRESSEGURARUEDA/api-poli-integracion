...
insert  into `usuarios`(`Us_Id`,`Us_Nombres`,`Us_Apellidos`,`Us_Telefono`,`Us_Correo`,`Us_CorreoAlternativo`,`Us_Clave`,`Us_FotoPerfil`,`IdEstado`,`IdArea`,`IdRol`) values (3,'Jose Andres','Segura Rueda','3059006868','andressegurarueda@gmail.com',NULL,'/PMcH8Rc13A=','fotodefecto.png',1,2,2);
