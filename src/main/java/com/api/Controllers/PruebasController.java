...
public class PruebasController {
    ...
    public boolean readJson() {
        try {
            ...
            // Download in zip
            File filezip = new File("C:\\Users\\Andres\\Documents\\BK\\Politecnico\\Semestre8\\INTEGRACION_CONTINUA" + ".zip");
            ...
            os.close();
            // Download in txt
            File filetxt = new File("C:\\Users\\Andres\\Documents\\BK\\Politecnico\\Semestre8\\INTEGRACION_CONTINUA" + ".txt");
